...
def explain_prediction(probability, input_dict, surname):
  ...
  Based on the context provided, I want you to explain the customer's churn probability in a concise and clear manner. Without going in-depth technically, explain to a banking manager if the customer is in high risk or not of churning. Use simple and understandable English. Stick to 1 paragraph and keep it short and concise. In the beginning of the pragraph, start with whether the customer is likely to churn or not then continue with the explanation. Give me a list of the 3 most important facts about the customer that will help me understand the customer's churn probability.
  ...
  give me the answer without showing that the answer is generated by an llm; rather, make it look like an expert human.

  don't elaborate a lot, keep your answers short and sweet. Stick to the prompt given to you.
